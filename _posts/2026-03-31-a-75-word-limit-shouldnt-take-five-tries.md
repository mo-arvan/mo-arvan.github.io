...
{% include figure.liquid path="assets/img/post_archehr/error_breakdown.png" caption="Error type breakdown across all experiments (dev and test combined, 1,171 cases). Word-count violations dominated; citation, schema, and format errors were rare." zoomable=true %}
